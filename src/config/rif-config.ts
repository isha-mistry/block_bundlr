...
export const RIF_RELAY_CONFIG = {
  ...
  smartWalletFactoryAddress: getAddress(
    "0xCBc3BC24da96Ef5606d3801E13E1DC6E98C5c877"
  ),
  relayHubAddress: getAddress("0xAd525463961399793f8716b0D85133ff7503a7C2"),
  deployVerifierAddress: getAddress(
    "0xc67f193Bb1D64F13FD49E2da6586a2F417e56b16"
  ),
  relayVerifierAddress: getAddress(
    "0xB86c972Ff212838C4c396199B27a0DBe45560df8"
  ),
  batchTransactionVerifierAddress: getAddress(
    "0xe94843C5fb22D6752049442Db3A03B7f8bfcAEe4"
  ), // To be deployed
...
export const GAS_COST_TIERS = {
  1: BigInt("100000000000000000"), // 0.1 RIF for 1 transaction (0.1 * 10^18)
  2: BigInt("200000000000000000"), // 0.2 RIF for 2-5 transactions (0.2 * 10^18)
  5: BigInt("200000000000000000"),
  6: BigInt("300000000000000000"), // 0.3 RIF for 6-10 transactions (0.3 * 10^18)
  10: BigInt("300000000000000000"),
  11: BigInt("500000000000000000"), // 0.5 RIF for 11-25 transactions (0.5 * 10^18)
  25: BigInt("500000000000000000"),
  26: BigInt("800000000000000000"), // 0.8 RIF for 26-50 transactions (0.8 * 10^18)
  50: BigInt("800000000000000000"),
} as const;
