...
export const CONTRACT_ABI = [
    ...
    inputs: [
      {
        ...
        internalType: "struct RIFRelayBatchTransactions.Transaction[]",
        name: "transactions",
        type: "tuple[]",
      },
      { internalType: "bool", name: "stopOnFailure", type: "bool" },
    ],
    name: "executeBatch",
    outputs: [
      {
        ...
        internalType: "struct RIFRelayBatchTransactions.BatchResult[]",
        name: "results",
        type: "tuple[]",
      },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256[]", name: "gasLimits", type: "uint256[]" },
      { internalType: "bool", name: "stopOnFailure", type: "bool" },
    ],
    name: "executeBatchWithGasLimits",
    outputs: [
      {
        components: [
          { internalType: "bool", name: "success", type: "bool" },
  ...
  {
    inputs: [
      { internalType: "uint256", name: "newMaxBatchSize", type: "uint256" },
    ],
  ...
  {
    inputs: [{ internalType: "uint256", name: "newMaxGas", type: "uint256" }],
